...
////START SEQUENCE - sccale up 
//  if (pressure_relative < 1100) {
//    moveY(maxSpeed75, maxSpeed75); //Down
//  }
//  if (pressure_relative >= 1100) {
//    moveY(deadValue, deadValue); //STOP
//  }
//
//  if (dist < 90){ //UNITS INCHES
//    moveY(maxSpeed75, maxSpeed75);
//  }
//
//  if (dist >= 90) {
//    moveY(deadValue, deadValue);
//    moveX(maxSpeed75, maxSpeed75);
//  }
